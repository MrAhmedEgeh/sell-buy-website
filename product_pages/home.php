...
include '../dbConnect.php';
      $query = "SELECT p.Product_Id, p.Product_Name, p.Price, p.img_url FROM product p, category c WHERE c.Category_Name = 'Home appliences' AND P.Product_Id = C.Product_Id";
